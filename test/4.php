 ...
 ul {min-height:10px;}
  ...
  ?>
		...
		$(document).ready(function(){
				...
				$("#bt").click(function(){
				var list =$("#li").val();
				var sortItemArray = $("#sortItemArray").val();
				
				//var data = list+sortItemArray
				
				var data = "listArray="+list+"&sortItemListArray="+sortItemArray;
		
				$.post("3.php",data,function(response){
...
if(foo==ss)
{
	...
	<body>
		<input id="li" value=""/><br />
		<input id="sortItemArray" /><br />
		<button id="bt" >Get Value</button>
	</body>
