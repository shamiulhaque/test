...
while ($row=mysql_fetch_assoc($result))
{
	...
	echo "<option value = '1'> First name: $row[firstname]</option>";
	echo "<option value = '2'> Last name: $row[lastname]</option>";
	echo "<option value = '3'> Email: $row[email]</option>";
	echo "<option value = '4'> Phone no: $row[phone]</option>";
	echo "<option value = '5'> Street address: $row[address]</option>";
	echo "<option value = '6'> Post code: $row[postcode]</option>";
	echo "<option value = '7'> City: $row[city]</option>";
...
echo "$row[lastname]";
		...
		<div id="info" style="height: 40px;">
			...
			<td><label style="color: #FF0000">Selected customer info has been displayed.</label></td>
			</tr>
			</table>
		</div>
