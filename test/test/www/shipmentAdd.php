...
$sql = "INSERT INTO shipment (customername,product,quantity,tax)
		VALUES ('$_POST[Cname]', '$_POST[Pname]', '$_POST[quantity]', '$_POST[tax]')";
				
if (!mysql_query($sql,$con))
{
	die("Error: ".mysql_error());	
}
$info="One shipment information has been added to your database.";
...
<?php while($row5 = mysql_fetch_array($result3))
  {
   ...
   echo"<option value='$row5[id]'>$row5[customername],$row5[product],$row5[quantity] </option>";
	...
	<label for="invice">Get shipment's invoice: </label>	
		<form action="shipmentIvnoice.php" method="post">
