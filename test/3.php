...
<?php
	if(isset($_REQUEST['listArray'])&& isset($_REQUEST['sortItemListArray'])){
		
		$listArray =array( $_REQUEST['listArray']);
		$sortItemListArray = $_REQUEST['sortItemListArray'];
...
for($m=0; $m<$listItems; $m++)
{
	...
	echo"<li id ='list_".$listId."' class='ui-state-default'><div>".$listArray[$m];echo"</div>";
